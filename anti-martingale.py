...
if __name__ == '__main__':
    ...
    for z in range(sim):
        ...
        if z == sim - 1:
            ...
            plt.plot(X, Y)
            plt.savefig("anti-martingale.png")
            plt.clf()
        ...
        for i in range(rounds):
            ...
            if (num > 1):
                ...
                if winner_index == 0:
                    fee = fee * 2
                    print("Player 0 won so betting double next round! The fee is {}".format(fee))
                else:
                    fee = fee / 2
                    print("Player 0 lost so betting halved next round! The fee is {}".format(fee))
                ...
                if z == sim - 1:
                    ...
                    print('The probability of winning with the anti-martingale strategy is {}% !'.format(probability))
